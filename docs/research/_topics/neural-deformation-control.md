...
- [2026-05-04-iphone-to-linux-webcam-transport.md](../2026-05-04-iphone-to-linux-webcam-transport.md) — companion research on iPhone-to-Linux RGB transport options (Reincubate Camo has no Linux client; alternatives: NDI HX, RTSP server apps, DroidCam/EpocCam variants).
