...
- [2026-05-05-arkit-bridge-v1-viability.md](../2026-05-05-arkit-bridge-v1-viability.md) — **viability gates.** Four-tier ship/hold framework (distill fidelity, category coverage, drop-in delta, subjective gate) with locked thresholds and a failure-mode → action decision matrix; consumed by Task 7 eval and Task 8 early-stop.
