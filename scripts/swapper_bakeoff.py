"""Swap-stage bake-off: inswapper_128 vs hyperswap_1a/1b/1c_256.
...
unmodified. inswapper_128 loads via the stock INSwapper class; HyperSwap is
the FaceFusion-port class imported from swap_core (where it is now the
default backend).
...
from swap_core import (HyperSwap, crop_and_upscale, detect_source,
