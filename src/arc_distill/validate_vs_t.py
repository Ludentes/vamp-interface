"""Validate a noise-conditional ArcFace adapter at t-buckets.
...
Gates from `docs/research/2026-04-30-noise-conditional-distill-design.md`:
  ...
  T2 — Schedule coverage. val cos at every t bucket {0.1, 0.25, 0.5, 0.75, 1.0}
       within 0.05 of the t=0 value.

(No L2 per-probe rig here — ArcFace embedding is identity, not attribute,
so the meaningful eval is direct cosine vs teacher.)
"""
